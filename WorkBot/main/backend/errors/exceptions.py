...
#            INFRA ERRORS
# -----------------------------------
class InfraError(ApplicationBaseError): ...
...
#             REPO ERRORS
# -----------------------------------
class RepositoryError(ApplicationBaseError): ...
...
# -----------------------------------
class DomainError(ApplicationBaseError): ...
...
#         APPLICATION ERRORS
# -----------------------------------
class ApplicationError(ApplicationBaseError): ...
